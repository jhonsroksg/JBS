      ...
      if (isLayawayMode) {
        ...
        const runBackgroundWork = async () => {
          try {
              ...
              try {
                ...
                if (existingCust) {
                  return db.update('customers', existingCust.id, {
                    ...
                    phone: phoneRaw || existingCust.phone,
            ...
            // NOTA: NO se resta stock aquí. El trigger validate_and_update_stock()
            // de Supabase ya descontó el stock de cada producto de forma atómica
            // (con bloqueo FOR UPDATE) dentro de la misma transacción del INSERT
            // en "orders", más arriba. Restarlo también aquí en el frontend
            // provocaba un DOBLE DESCUENTO de inventario por cada pedido nuevo.
            // Se elimina por completo para no duplicar la resta de stock ni
            // introducir una condición de carrera sin bloqueo de fila.
